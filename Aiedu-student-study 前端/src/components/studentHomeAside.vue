  ...
  <el-aside class="app-aside" width="250px">
    ...
    <div class="content-container">
      ...
      <el-menu
          ...
          :ellipsis="true"
      >
        <el-menu-item index="/student_home" class="el-menu-item">
          <el-icon name="collection"></el-icon>
          课程管理
        </el-menu-item>
        <el-menu-item index="/student_home_messages">
          <el-icon name="chat-dot-round"></el-icon>
          <MessageUnreadBadge />
        </el-menu-item>
        <el-menu-item index="/student_inbox">
          <el-icon name="message"></el-icon>
          收件箱
        </el-menu-item>
        <el-menu-item index="/student_home_cloud">
          <el-icon name="cloudy" ></el-icon>
          云盘
        </el-menu-item>
      </el-menu>
