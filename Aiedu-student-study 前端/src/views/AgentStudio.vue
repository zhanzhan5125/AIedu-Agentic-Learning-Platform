...
export default {
  data(){return{activeTab:'assignment',keywords:'',selectedChapterIds:[],count:5,difficulty:2,submitting:false,run:{},steps:[],timer:null,drafts:[],selectedDraft:null,draftForm:null,draftListLoading:false,draftLoading:false,draftEditing:false,draftSaving:false,publishDialogVisible:false,publishRange:[],publishSaving:false,publishPickerOptions:{disabledDate(time){return time.getTime()<Date.now()-86400000}},courseMap:null,publishedCourseMap:null,mapGenerating:false,mapSaving:false,editing:false,selectedNode:null,chart:null}},
  computed:{
