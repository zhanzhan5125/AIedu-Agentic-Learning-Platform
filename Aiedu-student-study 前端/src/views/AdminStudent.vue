            ...
            <div>
              ...
              <el-row class="search-button-container" style="margin-top: 20px;">
                <div class="demo-input-suffix">
                  <el-input placeholder="请输入学生姓名或编号" v-model="studentSearch" clearable class="search-input">
                ...
                <div style=" width: 100%; text-align: right;padding-right:20px">
                  ...
                  <el-button type="primary" round @click="handleClick()" style="margin-right: 10px">添加学生</el-button>
            ...
            <div class="table-container">
              <el-table :data="tableData" border stripe :header-cell-class-name="headerBg"
                ...
                <el-table-column label="操作" align="center">
                  <template slot-scope="scope">
                    <el-button  type="text" size="small" @click="handleReset(scope.row.sno)" style="margin-right: 20px">重置密码</el-button>
                    <el-popconfirm
                        confirm-button-text='确定'
                        cancel-button-text='我再想想'
                        icon="el-icon-info"
              ...
              <div class="el-dialog-div">
                ...
                <div class="switch_content">
                  ...
                  <div v-show="0===number">
                    ...
                    <el-form :model="studentForm" :rules="rules" ref="studentForm" style=" text-align: center;margin-right: 0">
                      ...
                      <el-form-item label="学生学号" prop="studentNumber">
                        <el-input v-model="studentForm.studentNumber" :maxlength="15" style="flex: 1;width: 60%"></el-input>
                      </el-form-item>
                      <el-form-item>
...
export default {
  ...
  methods: {
    ...
    load(){
      apiV1.get('/admin/users', {params:{role:'student',search:this.studentSearch||'',page:this.pageNum,page_size:this.pageSize}}
      ).then(res => {
        this.tableData = res.data.records.map(item=>({...item,sno:item.account,sname:item.name}))
    ...
    handleDelete(sNo){
      const row=this.tableData.find(item=>item.sno===sNo)
    ...
    handleReset(sNo){
      const row=this.tableData.find(item=>item.sno===sNo)
      apiV1.put(`/admin/users/${row.id}/password`,{password:sNo}).then(()=>{
    ...
    addStudent: function () {
      this.$refs['studentForm'].validate((valid) => {
        if(valid) {
          this.detailVisible = false;
          const addStudent = {
            sno:this.studentForm.studentNumber,
            sname:this.studentForm.studentName
          }
          apiV1.post('/admin/users',{role:'student',account:addStudent.sno,display_name:addStudent.sname,password:addStudent.sno}).then(() => {
